(function(){
    ...
    // Show all pizzas
    function allPizzas(){
        var url = "http://localhost:3001/pizzas";
        fetch(url)
                .then(checkStatus)
                .then(function(responseText) {   
                    ...
                    for (const key in allPizzas) {
                        ...
                        //document.getElementsByClassName("main")[0].innerHTML += '<div class="pizzas" id="'+ values[0].split(",")[2] + '"><p>' + key +' : </p> </div>'; //<button class="delete">Delete</button><button class="update-button">Update</button></div>';
    ...
    function deletePizzaConfirmed(id){
        ...
        var url = "http://localhost:3001/deletepizza";
    ...
    function updatePizza(id){
        ...
        if(pizzaName.length > 0 && (!(pizzaName in pizzasDataSet) ||  pizzasDataSet[pizzaName] == id) && atLeastOneCheckboxIsChecked(".checkbox-update")){
            ...
            var url = "http://localhost:3001/updatepizza";
    ...
    function newPizza(){
        ...
        var url = "http://localhost:3001/pizza";
		fetch(url, fetchOptions)
			.then(checkStatus)
			.then(function(responseText) {
                response = JSON.parse(responseText)
